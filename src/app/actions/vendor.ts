...
function storefrontCustomizationPayloadFromFormData(formData: FormData) {
  return {
    ...
    logoCrop: formData.get("logoCrop") || undefined,
    coverPhoto: formData.get("coverPhoto") || undefined,
    coverPhotoCrop: formData.get("coverPhotoCrop") || undefined,
    ...
    instagramFeedEnabled: formData.get("instagramFeedEnabled") || undefined,
    instagramFeedUrl: formData.get("instagramFeedUrl") || undefined,
...
function prepareStorefrontCustomizationPayload(parsed: StorefrontCustomizationInput, existingOfferingIds: string[]) {
  ...
  const draftPayload = JSON.parse(JSON.stringify({
    ...
    coverPhotoCrop: parsed.coverPhotoCrop ?? null,
...
export async function updateStorefrontCustomizationAction(formData: FormData) {
  ...
  await db.vendorProfile.update({
    ...
    data: {
      ...
      bio: parsed.bio || null,
      logoCrop: parsed.logoCrop ?? Prisma.JsonNull,
      logoUrl: parsed.logoUrl || null,
      coverPhoto: parsed.coverPhoto || null,
      coverPhotoCrop: parsed.coverPhotoCrop ?? Prisma.JsonNull,
      ...
      storefrontInstagramFeedEnabled: parsed.instagramFeedEnabled,
      storefrontInstagramFeedUrl: parsed.instagramFeedUrl || null,
