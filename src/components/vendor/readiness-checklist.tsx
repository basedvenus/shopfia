    ...
    <>
      ...
      <div className="mt-5 space-y-3">
        {items.map((item) => {
          ...
          const className = "group flex w-full items-center justify-between gap-3 rounded-[1.1rem] border border-[#eadbd8] bg-white p-3 text-left transition hover:-translate-y-0.5 hover:border-[#dfc7be] hover:shadow-[0_14px_30px_rgba(72,44,43,0.09)]";
          ...
          return item.href ? (
            ...
            <button
              ...
              type="button"
              onClick={() => item.targetId ? jumpToSection(item.targetId) : undefined}
              className={className}
            >
              {content}
            </button>
